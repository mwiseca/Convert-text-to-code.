...
void choice() {
	...
	printf("//Enter min for multi if statements with 2 conditions for numbers.\n");
	...
	printf("//Enter fcb to check fgets and clear input buffer after selecting cb.\n");
...
void mapArrays() {
    ...
    while(1) {
        ...
        printf("//Enter the value array name m for main.\n");
...
void mapNum() {
    ...
    while(1) {
        ...
        printf("//Enter the name of the  int or double user input m for main.\n");
        while(fgets(select,SIZE,stdin) == NULL) {
            checkInput();
        }
        select[strcspn(select,"\n")]=0;
