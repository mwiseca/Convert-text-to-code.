...
void map() {
    ...
    while (1) {
        ...
        printf("//");
        while(fgets(key_type,150, stdin)) {
        key_type[strcspn(key_type, "\n")] = 0;
	    if (strlen(key_type) >=149) {
		clear();      
		printf("\nYou entered to many characters.\n\n"); 
		printf("//");
	    }else if (strcmp(key_type, "s") != 0 && strcmp(key_type, "i") != 0 && strcmp(key_type, "d") != 0) {
        ...
        printf("//");
        while (fgets(value_type,150, stdin)) {
            value_type[strcspn(value_type, "\n")] = 0;
	    if (strlen(value_type) >=149) {
		clear();      
		printf("\nYou entered to many characters.\n\n"); 
		printf("//");
	    } else if (strcmp(value_type, "s") != 0 && strcmp(value_type, "i") != 0 && strcmp(value_type, "d") != 0) {
                printf("//Enter s i or d only.\n");
		printf("//");
            } else {
                break;
        ...
        printf("//");
        while(fgets(value_t,150, stdin)) {
             value_t[strcspn(value_t, "\n")] = 0;
	    if (strlen(value_t) >= 149) {
		clear(); 
	        printf("\nYou entered to many characters.\n\n");
	        printf("//");
	    } else {
